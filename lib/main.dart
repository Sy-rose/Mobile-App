...
import 'package:health_metrics_tracker/firebase_options.dart';
...
void main() async {
  ...
  HealthMetricFirebaseRemoteDatasource datasource =
      HealthMetricFirebaseRemoteDatasource(FirebaseFirestore.instance);

  // ignore: prefer_const_constructors
  final testHealthMetric = HealthMetric(
    id: '1', // String is correct here
    patientId: "p001", // String is correct here
    date: DateTime.now(), // Correct DateTime instance
    systolicBP: 120, // Should be an integer, not a decimal
    diastolicBP: 80, // Should be an integer, not a decimal
